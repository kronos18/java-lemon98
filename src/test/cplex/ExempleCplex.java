...
public class ExempleCplex {
    ...
    public static void main(String[] args) throws IloException {
        ...
        // variables
        IloNumVar x1 = model.numVar(0.0,
                                    Double.MAX_VALUE,
                                    "x_1");
        IloNumVar x2 = model.numVar(0.0,
                                    Double.MAX_VALUE,
                                    "x_2");

        // fonction objectif
        IloNumExpr obj = model.sum(model.prod(2.0,
                                              x1),
                                   x2);
        ...
        // Contrainte 1
        IloNumExpr expr1 = model.sum(model.prod(5.0,
                                                x1),
                                     model.prod(8,
                                                x2));
        model.addLe(expr1,
        ...
        // Contrainte 2
        IloNumExpr expr2 = model.sum(model.prod(8.0,
                                                x1),
                                     model.prod(4,
                                                x2));
        model.addLe(expr2,
        ...
        // Contrainte 3
        IloNumExpr expr3 = model.sum(model.prod(12.0,
                                                x1),
                                     model.prod(4,
                                                x2));
        model.addLe(expr3,
